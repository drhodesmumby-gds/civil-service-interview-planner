...
export const AboutView: React.FC<AboutViewProps> = ({ onBack }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-[#f3f2f1] font-sans text-[#0b0c0c]">
      {/* Sticky Header */}
      <header className="px-6 py-4 flex items-center justify-between shadow-sm z-20 shrink-0 sticky top-0 bg-white border-b-2 border-[#0b0c0c]">
        <button 
          onClick={onBack} 
          className="govuk-back-link my-0 text-sm font-bold"
        >
          Back to Planner
        </button>
        <div className="flex items-center gap-2">
          <span className="bg-[#ffdd00] text-[#0b0c0c] text-xs font-bold px-2.5 py-1 border border-[#0b0c0c]">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden max-w-7xl w-full mx-auto">
        ...
        <nav className="shrink-0 p-4 md:p-6 md:w-64 border-b md:border-b-0 md:border-r z-10 sticky top-0 md:top-auto overflow-x-auto md:overflow-y-auto flex md:flex-col gap-1.5 bg-white border-[#b1b4b6]">
          <div className="hidden md:block mb-3 px-1">
            <h2 className="text-xs font-bold uppercase tracking-wider text-[#505a5f]">
              In-Page Navigation
            </h2>
          </div>
          {navItems.map((item) => {
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-10 space-y-12 scroll-smooth">
          ...
          <section id="overview" className="scroll-mt-6 space-y-4">
            <div className="flex items-center gap-3 border-b-4 border-[#0b0c0c] pb-3">
              <div className="p-2 bg-[#0b0c0c] text-white">
                <FileText className="w-6 h-6" />
              </div>
              <h1 className="text-3xl font-bold text-[#0b0c0c] tracking-normal">
                About This Tool
              </h1>
            </div>
            <p className="govuk-body govuk-!-font-size-19 text-[#0b0c0c]">
          ...
          <section 
            id="personal-note" 
            className="scroll-mt-6 p-6 md:p-8 bg-white border-2 border-[#b1b4b6] border-t-4 border-t-[#1d70b8]"
          >
            <div className="flex items-center gap-3 mb-4 border-b-2 border-[#b1b4b6] pb-3">
              <Heart className="w-6 h-6 text-[#1d70b8]" />
              <h2 className="text-2xl font-bold text-[#0b0c0c]">
                Personal Note
              </h2>
            </div>
            <div className="space-y-4 govuk-body govuk-!-font-size-16 text-[#0b0c0c] border-l-4 border-[#1d70b8] pl-5 py-1 bg-[#f3f2f1]">
              <p>
                I vibed this sometime in late 2025 to assist in preparing for a lengthy round of interviews, in which I always struggled on timing my questions in particular. I always meant to make it public but never quite got round to it, and now feel slightly guilted into it by the recent announcement that <a href="https://www.civilserviceworld.com/professions/article/civil-service-success-profiles-to-be-scrapped" target="_blank" rel="noreferrer" className="text-[#1d70b8] underline font-bold hover:text-[#003078]">Success Profiles are being scrapped</a>. I say guilted - there is a genuine feeling there, as I did genuinely actually find the tool very useful for my prep as a neurodiverse candidate, and I do wonder if it could have been more helpful for others using Success Profiles.
              </p>
              <p>
          ...
          <section id="api-key-models" className="scroll-mt-6 p-6 md:p-8 bg-white border-2 border-[#b1b4b6] space-y-6">
            <div className="flex items-center gap-3 border-b-2 border-[#b1b4b6] pb-3">
              <KeyRound className="w-6 h-6 text-[#1d70b8]" />
              <h2 className="text-2xl font-bold text-[#0b0c0c]">
                API Key & AI Models
              </h2>
            </div>
            
            <div className="space-y-4 govuk-body govuk-!-font-size-16 text-[#0b0c0c]">
              ...
              <div className="grid md:grid-cols-3 gap-4 pt-2">
                <div className="p-4 bg-[#f3f2f1] border-2 border-[#b1b4b6]">
                  <h3 className="font-bold mb-1 flex items-center gap-2 text-[#0b0c0c] text-base">
              ...
              <div className="border-2 border-[#1d70b8] bg-white mt-4">
                ...
                <div className="p-4 space-y-1 text-sm text-[#0b0c0c]">
          ...
          <section id="how-to-prepare" className="scroll-mt-6 space-y-6">
            <h2 className="text-2xl font-bold text-[#0b0c0c] border-b-2 border-[#b1b4b6] pb-3">
              How to Prepare
            </h2>
            
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 bg-white border-2 border-[#b1b4b6]">
                <div className="flex items-center gap-3 mb-3">
                  <span className="w-7 h-7 font-bold flex items-center justify-center shrink-0 text-sm bg-[#0b0c0c] text-white">1</span>
                  <h3 className="text-lg font-bold text-[#0b0c0c]">Context & Career History</h3>
                </div>
                <p className="text-sm leading-relaxed text-[#0b0c0c]">
              ...
              <div className="p-6 bg-white border-2 border-[#b1b4b6]">
                <div className="flex items-center gap-3 mb-3">
                  <span className="w-7 h-7 font-bold flex items-center justify-center shrink-0 text-sm bg-[#0b0c0c] text-white">2</span>
                  <h3 className="text-lg font-bold text-[#0b0c0c]">Plan & Structure</h3>
                </div>
                <p className="text-sm leading-relaxed text-[#0b0c0c]">
              ...
              <div className="p-6 bg-white border-2 border-[#b1b4b6]">
                <div className="flex items-center gap-3 mb-3">
                  <span className="w-7 h-7 font-bold flex items-center justify-center shrink-0 text-sm bg-[#0b0c0c] text-white">3</span>
                  <h3 className="text-lg font-bold text-[#0b0c0c]">Mock Practice & Auto-scroll</h3>
                </div>
                <p className="text-sm leading-relaxed text-[#0b0c0c]">
              ...
              <div className="p-6 bg-white border-2 border-[#b1b4b6]">
                <div className="flex items-center gap-3 mb-3">
                  <span className="w-7 h-7 font-bold flex items-center justify-center shrink-0 text-sm bg-[#0b0c0c] text-white">4</span>
                  <h3 className="text-lg font-bold text-[#0b0c0c]">Follow-up Predictor</h3>
                </div>
                <p className="text-sm leading-relaxed text-[#0b0c0c]">
          ...
          <section id="disclaimer" className="scroll-mt-6 p-6 bg-white border-2 border-[#0b0c0c] border-l-[12px] border-l-[#d4351c]">
            <div className="flex items-start gap-4">
              <div className="shrink-0 flex items-center justify-center font-bold w-8 h-8 rounded-full bg-[#d4351c] text-white text-xl">
                !
              </div>
              <div className="space-y-2">
                <h2 className="text-xl font-bold text-[#0b0c0c]">
                  Notice & Disclaimer
                </h2>
                <p className="text-sm leading-relaxed text-[#0b0c0c]">
